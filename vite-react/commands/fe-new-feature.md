...
Run the `fe-extract-features` command with `$ARGUMENTS` as the argument to generate the initial doc for the new feature.
...
Next steps:
  ...
  4. Run /fe-sync-docs any time to keep docs up to date
```
