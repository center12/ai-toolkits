...
description: Read all analysis/<NN>-*.md feature files and write analysis/be-cross-analysis.md with cross-cutting patterns, issue heatmap, and aggregated scores.
---
